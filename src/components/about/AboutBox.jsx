  ...
  return (
    <div className='md:flex md:flex-row flex-col mt-16 justify-center gap-24'>
      <div className='flex gap-4 items-center'>
        ...
        <div>
          <h3 className='font-bold text-2xl text-gray-700'>10+</h3>
      ...
      <div className='flex gap-4 mt-5 md:mt-0 items-center'>
        ...
        <div>
          <h3 className='font-bold text-2xl text-gray-700'>100+</h3>
      ...
      <div className='flex gap-4 mt-5 md:mt-0 items-center'>
        ...
        <div>
          <h3 className='font-bold text-2xl text-gray-700'>10+</h3>
          <span className='font-semibold text-gray-700'>Happy Clients</span>
        </div>
      </div>
    </div>
  );
